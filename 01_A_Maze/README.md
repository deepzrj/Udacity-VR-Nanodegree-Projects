...
The following project is made by Deepthy Rose Jose. 
It is a Maze where the user needs to find the hidden key to unlock the door to the treasure. 
Free assets from Unity store is used also.
The main scene name is kept as "Main" and no other scenes are added.
GVR SDK for Unity v1.190.1 (2019-01-16) is used
Target deployment platform used are Windows,Linux and PC. Also,Android.
